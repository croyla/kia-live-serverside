...
from old_src.shared import scheduled_timings, routes_children, routes_parent, start_times
from old_src.live_data_service.live_data_getter import fetch_route_data, _get_adaptive_connector_limits
from old_src.live_data_service.live_data_transformer import transform_response_to_feed_entities
from old_src.live_data_service.feed_entity_updater import update_feed_message
from old_src.shared.utils import generate_trip_id_timing_map
...
def _get_adaptive_fetch_timeout():
    ...
    try:
        from old_src.live_data_service.live_data_getter import _detect_hardware_performance
...
def _get_processing_semaphore():
    ...
    try:
        from old_src.live_data_service.live_data_getter import _calculate_resource_allocation
