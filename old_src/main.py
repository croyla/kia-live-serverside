...
from old_src.local_file_service.local_file_service import process_once, LocalFileService
from old_src.live_data_service.live_data_scheduler import schedule_thread
from old_src.live_data_service.live_data_receiver import live_data_receiver_loop
from old_src.web_service import run_web_service
from old_src.shared.db import initialize_database
from old_src.shared.memory_config import get_memory_config, get_hardware_profile
from old_src.shared.monitor import start_monitoring, stop_monitoring, get_performance_summary
...
class ManagedEventLoop:
    ...
    async def run_receiver_loop(self):
        ...
        try:
            ...
            from old_src.live_data_service.live_data_receiver import live_data_receiver_loop, cancel_all_tasks
            ...
            try:
                from old_src.live_data_service.live_data_receiver import cancel_all_tasks
