...
# Bounded, de-duplicated static enrichment store for live-added trip schedules
# Value for each route_key is a deque(maxlen=8) of dicts: {"start": int HHMM, "stops": [{stop_id, stop_time}]}
static_enriched_times = ThreadSafeDict(max_size=256, max_age_seconds=3*3600, max_memory_mb=10)
